...
prefix_messages = [
    ChatMessage(
        role="system",
        content=(
            "You are now a integration agent, and whatever you are requested, you will try to execute utilizing your tools."
        ),
    )
]
...
response = agent.chat("Search through hackernews and find me only 1 post where people discuss ideas about building AI agents or agentic AI. Go back in time if you cannot find posts from today.")
